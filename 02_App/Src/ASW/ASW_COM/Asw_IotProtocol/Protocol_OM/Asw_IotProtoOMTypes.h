...
typedef enum{
    ...
    eIotOMUpdateResult_Allow = 0,           /* 允许升级 */
    eIotOMUpdateResult_NotAllow,            /* 不满足升级条件 */
    eIotOMUpdateResult_FWDevNotMatch,       /* 程序与设备型号不符 */
    eIotOMUpdateResult_DownLoadTimeOut,     /* 下载更新文件超时 */
    eIotOMUpdateResult_FWHWNotMath,         /* 程序与升级硬件不符 */
    eIotOMUpdateResult_FileNameErr,         /* 文件名错误 */
    eIotOMUpdateResult_MD5Err,              /* MD5校验失败 */
    eIotOMUpdateResult_IDLEDo = 0x10,       /* 等待空闲执行 */
    eIotOMUpdateResult_Success,             /* 升级成功 */
    eIotOMUpdateResult_Failed,              /* 升级失败 */
    eIotOMUpdateResult_Alive,               /* 存在其他升级任务 */
    eIotOMUpdateResult_WaitIntall,          /* 下载更新文件已完成, 等待升级中 */

}IotOMUpdateResult_Enum;
/******************************************************************************
*    Typedef Definition
******************************************************************************/
