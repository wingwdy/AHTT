...
/* 发送CMD计数 (实际有效帧数: F1/F3/F5/F8/B1/B5/B6/B10/B24/B31/B34/B40/B46/B48/B49/B52/B53/B57) */
#define IOT_AP_CMD_SEND_COUNT                  (18)
...
typedef enum
{
    ...
    eIotAPStopReason_BMSStop = 51,             /* BMS 正常终止充电 */
    eIotAPStopReason_OtherErr = 54,            /* 其他故障 */
    eIotAPStopReason_PEBreakFault = 113,       /* PE接地/绝缘监测 */
    eIotAPStopReason_LNReversed = 114,         /* 电池极性反接故障 */
    eIotAPStopReason_ShortCircleErr = 233,     /* 输出短路故障 */ 

    eIotAPStopReason_InsuffBalance = 300,      /* 账户余额不足 */
    eIotAPStopReason_SumNoEnough = 301,        /* 达到设定金额 */
    eIotAPStopReason_TimeEnough = 302,         /* 达到设定时间 */
    eIotAPStopReason_EnergyEnough = 303,       /* 达到设定电量 */
    eIotAPStopReason_NetNoSIMErr = 310,        /* 桩禁用 */
    eIotAPStopReason_PlatformOffline = 311,    /* 桩离线，与平台通讯断 */
    eIotAPStopReason_PowerOff = 312,           /* 系统掉电 */
    eIotAPStopReason_Card = 314,               /* 刷卡停止 */
    eIotAPStopReason_StartTimeout = 320,       /* 启动超时停止 */
    eIotAPStopReason_MeterCalcErr = 321,       /* 电表读数异常 */    
    eIotAPStopReason_HmiCommErr = 325,         /* 本地管理员停止 */
    eIotAPStopReason_MeterCommErr = 326,       /* 电表通信故障 */
    eIotAPStopReason_eErr_DatabaseErr = 327,   /* CTR通讯故障 */
    eIotAPStopReason_ReaderCommErr = 328,      /* 刷卡器通信故障 */        
    eIotAPStopReason_RCDSelfcheckErr = 330,    /* 电表-窃电异常 */ 

    /* ====== 启动失败上报专用停止原因(B53零费用交易记录用) ====== */
    eIotAPStartFail_DataInvalid = 200,         /* 数据合法性校验失败(port越界) */
    eIotAPStartFail_ParamNotReady = 203,       /* 下发充电参数未完成(计费模型无效) */
    eIotAPStartFail_PauseService = 204,        /* 充电桩暂停服务(订单非空闲) */
    eIotAPStartFail_WorkingState = 205,        /* 充电桩处于"工作"状态(已鉴权) */
    eIotAPStartFail_PauseState = 206,          /* 充电桩处于"暂停"状态(充电条件不允许) */
    eIotAPStartFail_NotConnected = 207,        /* 充电桩与车辆未连接(枪未连接) */
    eIotAPStartFail_UpDating = 234,            /* 正在充电(升级中) */
    eIotAPStartFail_Other = 235,               /* 桩禁用(禁充状态) */
