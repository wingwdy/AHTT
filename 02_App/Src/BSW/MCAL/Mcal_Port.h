...
typedef enum
{
    ...
    eMcalPortPinChanel_PA9_4GTX,                    /* 4G 串口发送 ***/
    eMcalPortPinChanel_PA10_4GRx,                   /* 4G 串口接收 ***/
    eMcalPortPinChanel_PA11_DebugTx,                /* 调试口，发送 */
    eMcalPortPinChanel_PA12_DebugRx,                /* 调试口，接收 */
    eMcalPortPinChanel_PA15_NFCRST3,                /* RFID 复位脚 ***/
    ...
    eMcalPortPinChanel_PB6_NorFlashSpiCS,           /* NorFlash的spi片选 ***/  
    eMcalPortPinChanel_PB7_Reserve,                 /* 预留 */ 
    eMcalPortPinChanel_PB8_Reserve,                 /* 预留 ***/ 
    ...
    eMcalPortPinChanel_PC10_NFCSpiCLK,              /* NFC的spi时钟线 ***/  
    eMcalPortPinChanel_PC11_NFCSpiMISO,             /* NFC的spi输入 ***/
    eMcalPortPinChanel_PC12_NFCSpiMOSI,             /* NFC的spi输出 ***/
    eMcalPortPinChanel_PC13_Reserve,                /* 预留 */
    eMcalPortPinChanel_PC14_4GPwrKeyEn,             /* 4G开机脚 */
    eMcalPortPinChanel_PC15_4GPwrEn,                /* 4G电源控制 */
    
    eMcalPortPinChanel_PD2_NFCSpiCS,                /* NFC的spi片选 ***/
