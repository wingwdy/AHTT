...
const ATUrcDescribtor_Struct c_stATUrcDescribtor[17] =
{
    ...
    { "+QHTTPPOST:",          "\r\n",   ATHTTP_UrcQHTTPPost,      TRUE,    "HTTP POST响应"},
    { "+QHTTPGET:",           "\r\n",   ATHTTP_UrcQHTTPGet,       TRUE,    "HTTP GET响应"},
    { "+QHTTPREAD:",          "\r\n",   ATHTTP_UrcQHTTPRead,      TRUE,    "HTTP READ响应"},
};
