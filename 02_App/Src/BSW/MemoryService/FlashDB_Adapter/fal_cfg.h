...
#define FAL_TSDB_NAME_OM_CHARGE_RECORD         "om_charge_record_tsdb"
#define FAL_TSDB_NAME_METER_RECORD             "meter_record_tsdb"
...
#define FAL_TSDB_OM_CHARGE_RECORD_START_ADDR   (FAL_TSDB_CHARGE_RECORD_SIZE + FAL_TSDB_CHARGE_RECORD_START_ADDR)
#define FAL_TSDB_OM_CHARGE_RECORD_SIZE         (1 * 512 * 1024)

#define FAL_TSDB_ERROR_RECORD_START_ADDR       (FAL_TSDB_OM_CHARGE_RECORD_SIZE + FAL_TSDB_OM_CHARGE_RECORD_START_ADDR)
...
#define FAL_TSDB_METER_RECORD_START_ADDR       (FAL_TSDB_RUNNING_LOG_SIZE + FAL_TSDB_RUNNING_LOG_START_ADDR)
#define FAL_TSDB_METER_RECORD_SIZE             (1 * 16 * 1024)
...
{                                                                                                                                                       \
    ...
    {FAL_PART_MAGIC_WORD, FAL_TSDB_NAME_OM_CHARGE_RECORD, NOR_FLASH_DEV_NAME,  FAL_TSDB_OM_CHARGE_RECORD_START_ADDR,  FAL_TSDB_OM_CHARGE_RECORD_SIZE, 0}, \
    ...
    {FAL_PART_MAGIC_WORD, FAL_TSDB_NAME_METER_RECORD,     NOR_FLASH_DEV_NAME,  FAL_TSDB_METER_RECORD_START_ADDR,      FAL_TSDB_METER_RECORD_SIZE,     0}, \
