...
void Common_Uint32ToThreeUint8(uint8_t *pData, uint32_t curVal);
uint32_t Common_FourUint8ToUint32(uint8_t *pData);
uint16_t Common_TwoUint8ToUint16(uint8_t *pData);
uint32_t Common_ThreeUint8ToUint32(uint8_t *pData);
void Common_Uint16ToTwoUint8(uint8_t *pData, uint16_t curVal);
void Common_Uint32ToThreeUint8(uint8_t *pData, uint32_t value);
...
uint16_t Common_ReplaceNum(uint8_t* pData, uint16_t nDataLen, char* cDestStr, uint32_t replace, uint32_t defaultNum);
