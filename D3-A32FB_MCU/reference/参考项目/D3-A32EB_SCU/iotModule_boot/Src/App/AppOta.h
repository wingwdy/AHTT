...
/*ota*/
#define APP_MAX_FRAME_CNT       	384	        //程序最大空间，单位K
#define OTA_FRAME_SIZE        		1024		//下载一帧长度1024
#define APP_MAX_SIZE        		(OTA_FRAME_SIZE*APP_MAX_FRAME_CNT)	//
#define OTA_DOWNLOAD_ADRR 			((uint32_t)0x00010000)//升级区
#define OTA_BACKUP_ADRR 			((uint32_t)0x00070000)//备份区

//#define EXT_FLASH_ADDR_OTA_DOWNLOAD	            0x00010000	//外部flash,升级下载区起始地址
//#define EXT_FLASH_LEN_OTA_FILESIZE	            0x00040000	//外部flash,升级下载区大小
