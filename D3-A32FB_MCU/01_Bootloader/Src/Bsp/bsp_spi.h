...
#define     SPI_RCUSPIx                 RCU_SPI2
#define     SPI_SPIx                    SPI2

#define     SPI_CS_RCU_GPIOx            RCU_GPIOB
#define     SPI_CS_GPIOx                GPIOB
#define     SPI_CS_GPIO_Pin             GPIO_PIN_6

#define     SPI_SCLK_RCU_GPIOx          RCU_GPIOB
#define     SPI_SCLK_GPIOx              GPIOB
#define     SPI_SCLK_GPIO_Pin           GPIO_PIN_3

#define     SPI_MISO_RCU_GPIOx          RCU_GPIOB
#define     SPI_MISO_GPIOx              GPIOB
#define     SPI_MISO_GPIO_Pin           GPIO_PIN_4

#define     SPI_MOSI_RCU_GPIOx          RCU_GPIOB
#define     SPI_MOSI_GPIOx              GPIOB
