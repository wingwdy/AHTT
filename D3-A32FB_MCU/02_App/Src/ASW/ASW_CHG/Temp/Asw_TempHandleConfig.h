...
#define ASWTEMP_CFG_DebugPrint(fmt, ...)                DSLOGM_Debug(DSLogMModule_Temp, fmt, ##__VA_ARGS__)
#define ASWTEMP_CFG_InfoPrint(fmt, ...)                 DSLOGM_Info(DSLogMModule_Temp, fmt, ##__VA_ARGS__)
/******************************************************************************
*    Enum Definition
******************************************************************************/
