...
#define ASWCHARGE_CFG_DebugPrint(fmt, ...)             DSLOGM_Debug(DSLogMModule_Charge, fmt, ##__VA_ARGS__)
#define ASWCHARGE_CFG_InfoPrint(fmt, ...)              DSLOGM_Info(DSLogMModule_Charge, fmt, ##__VA_ARGS__)
