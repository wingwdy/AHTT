...
typedef enum
{
    eAswLedEventWorkState_Init,          /* 初始状态 */
    eAswLedEventWorkState_Delay,         /* 延时状态 */
    eAswLedEventWorkState_Normal,        /* 正常状态 */
}AswLedEventWorkState_Enum;
...
static AswLedEventWorkState_Enum g_ledEventWorkState = eAswLedEventWorkState_Init;
...
void AswLedEvent_MainFunction(void)
{
    ...
    switch (g_ledEventWorkState)
    {
        case eAswLedEventWorkState_Init:
        {
            g_ledEventWorkState = eAswLedEventWorkState_Delay;
            g_startupTick = Common_GetSystick();
            break;
        }

        case eAswLedEventWorkState_Delay:
        {
            if (Common_JudgeTimeoutMs(g_startupTick, 200))
            {
                g_ledEventWorkState = eAswLedEventWorkState_Normal;
            }

            break;
        }

        case eAswLedEventWorkState_Normal:
        {
        ...
        default:
        {
            g_ledEventWorkState = eAswLedEventWorkState_Init;
            break;
        }
    }
}
