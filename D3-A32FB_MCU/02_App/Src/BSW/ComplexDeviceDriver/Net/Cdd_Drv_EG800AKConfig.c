...
const CddDrvEG800AKSocketConfig_Struct c_stCddDrvEG800AKSocketConfigTable[eCddNetMSocketType_Count] =
{
    ...
    [eCddNetMSocketType_TCP] = 
    {
        ...
        .recvTransparentData = NULL,
        .updateIpPort = ATTCP_UpdateIpPort,
    },
    ...
    {
        .cmdTaskCount = eATHTTPCmd_Count,
        .pATCmdDescribtorTable = c_stHTTPATCmdDescribtor,
        .stateHandle = ATHTTP_StateHandle,
        .socketCloseHandle = ATHTTP_CloseSocket,
        .recvTransparentData = NULL,
    },
};
