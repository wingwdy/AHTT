...
#define DSCONSOLE_CFG_DebugPrint(fmt, ...)       DSLOGM_Debug(DSLogMModule_Console, fmt, ##__VA_ARGS__)
#define DSCONSOLE_CFG_InfoPrint(fmt, ...)        DSLOGM_Info(DSLogMModule_Console, fmt, ##__VA_ARGS__)
/******************************************************************************
*    Enum Definition
******************************************************************************/
